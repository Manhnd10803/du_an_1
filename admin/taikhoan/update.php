<div class="noidung">
    <form action="index.php?act=updatetk" method="post">
        ...
        <input type="text" placeholder="Tên tài khoản" value="<?php echo $taikhoan['ma_kh']?>" name="username" required>
        ...
        <input type="text" placeholder="Vai trò" name="vai_tro" value="<?php echo $taikhoan['vai_tro']?>" required>
